namespace CakeShop.Web.Controllers
{
    ...
    public class OrdersController : BaseController
    {
        ...
        public async Task<ActionResult<DessertOrderViewModel>> AddToBasket([FromBody] AddToOrderInputModel input)
        {
            ...
            {
                //todo totalPrice
                return new DessertOrderViewModel { Message = GlobalConstants.ErrorDessertQuantity, IsSuccess = false };
            }
            ...
            var totalPrice = await this.ordersService.GetTotalPriceCurrentOrderAsync(orderId);

            return new DessertOrderViewModel { TotalPrice = totalPrice, Message = GlobalConstants.AddedToBasketSuccessfully, IsSuccess = true };
        }
    }
}
